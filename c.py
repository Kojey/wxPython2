...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        pause = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('icon/pause.png'))
        play  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('icon/play.png'))
        forw  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('icon/forw.png'))
        back  = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('icon/back.png'))
        vol = wx.BitmapButton(pnl2, bitmap=wx.Bitmap('icon/volume.png'))
