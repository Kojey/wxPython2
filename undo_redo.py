...
class Newt(wx.Frame):
    def __init__(self,parent,id,title):
        ...
        quit.SetBitmap(wx.Bitmap('icon/texit.png'))
        ...
        self.toolbar.AddSimpleTool(ID_UNDO, wx.Bitmap('icon/tundo.png'),
              'Undo', '')
        self.toolbar.AddSimpleTool(ID_REDO, wx.Bitmap('icon/tredo.png'),
              'Redo', '')
        self.toolbar.EnableTool(ID_UNDO, False)

        self.toolbar.EnableTool(ID_REDO, False)
        self.toolbar.AddSeparator()
        self.toolbar.AddSimpleTool(ID_EXIT, wx.Bitmap('icon/texit.png'),
              'Quit', '')
